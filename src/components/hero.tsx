  ...
  return (
    <div className="flex flex-col items-center justify-center gap-6 w-full px-2 sm:px-4">
      <div className="flex flex-col items-center justify-center gap-6 w-full">
        <div className="scale-25 w-fit -m-[12.5%] flex items-center justify-center">
          <Logo />
        </div>
      ...
      <Benefits />
      <div className="flex flex-col items-center justify-center gap-2 w-full max-w-2xl mt-4 px-4">
